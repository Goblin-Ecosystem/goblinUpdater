package code.update.impl.or.helpers;
...
public class GraphLP {
    ...
    public static <N extends UpdateNode, E extends UpdateEdge> String edgeVariableName(Graph<N, E> g, E e, String prefix) {
        return prefix + e.name() + "_" + g.source(e).name() + "->" + g.target(e).name();
    }

    public static <N extends UpdateNode, E extends UpdateEdge>String dependencyVariableName(Graph<N, E> g, E e) {
        return edgeVariableName(g, e, ED_PREFIX);
    }

    public static <N extends UpdateNode, E extends UpdateEdge>String possibilityVariableName(Graph<N, E> g, E e) {
        return edgeVariableName(g, e, EP_PREFIX);
    }

    public static <N extends UpdateNode, E extends UpdateEdge>MPVariable dependencyVariable(MPSolver s, Graph<N, E> g, E e) {
        return s.lookupVariableOrNull(dependencyVariableName(g, e));
    }

    public static <N extends UpdateNode, E extends UpdateEdge>MPVariable possibilityVariable(MPSolver s, Graph<N, E> g, E e) {
