...
public class ClientMock {
    ...
    public static void main(String[] args) {
        ...
        UpdateGraph<UpdateNode, UpdateEdge> g = switch (EXAMPLE) {
            ...
            // ----------
            //
            // first set of experiments, with constraints in LP relative to change arcs
            // missing (this is 2 constraints for each change arc, there are n*m*m changes
            // arcs, eg 400,000 on a 1000x20 problem which means 800,000 constraints missing
            // !)
            //
            // 1st experiment:
            // generateExample001
            ...
            // 3rd experiment:
            // generateExample002
            // no multi-core specified, regular structure, zero quality, regular
            // dependencies
            //
            // #A, #R/A, Q?, cores : solving time : total time
            ...
            //
            // COMMENTS:
            // - change arcs seem very costly, is there a way to have less of them (or do
            // not use them)? In reality, we do not have a lot of change arcs but possibly
            // for the root. -> develop a new example generator that takes this into account
            // given some reality measures.
            // - this raises the question of synthetic examples vs reality. We need a set of
            // real examples soon.
            //
            // 7th experiment:
            ...
            // - this does not mean we do not have choices to make (we still have m versions
            // per artifact), just that we won't be able to take into account a cost
            // everyhere
            //
            // 8th experiment:
            // UPDATED Graph Generation: "realistic" freshness values
            // generateExample004
            // multi-core specified, regular structure, freshness+popularity quality,
            ...
            //
            // COMMENTS:
            // - the demo popularity measure used in synthetic graph generation is bad (not
            // really discriminating version 1 to 6), anyway, it is not the objective here
